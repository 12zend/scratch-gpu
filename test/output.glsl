...
float sc_v_x;
uniform float sc_u_cam_x;
float sc_v_cam_x;
uniform float sc_u_cam_cos;
float sc_v_cam_cos;
uniform float sc_u_cam_sin;
float sc_v_cam_sin;
uniform float sc_u_cam_size;
float sc_v_cam_size;
float sc_v_y;
uniform float sc_u_cam_y;
float sc_v_cam_y;
float sc_v_color_r;
float sc_v_color_g;
float sc_v_color_b;
uniform float sc_u_fade_in;
float sc_v_fade_in;
uniform float sc_u_fade_out;
float sc_v_fade_out;
float sc_v_dist;
float sc_v_atan;
uniform float sc_u_beat;
float sc_v_beat;
float sc_v_i;
float sc_v_light;
float sc_v_light2;
float sc_v_color_a;
uniform float sc_u_le_t;
float sc_v_le_t;
float sc_v_x2;
float sc_v_y2;
uniform float sc_u_sw_radius1;
float sc_v_sw_radius1;
uniform float sc_u_sw_radius2;
float sc_v_sw_radius2;
uniform float sc_u_text_size;
float sc_v_text_size;
uniform float sc_u_text_dir;
float sc_v_text_dir;
uniform float sc_u_flash;
float sc_v_flash;
float sc_color;
...
void sc_fn_pixel_s_s(in float sc_a_x, in float sc_a_y) {
  sc_v_x = (mod(((sc_v_cam_x + (((sc_a_x * sc_v_cam_cos) - (sc_a_y * sc_v_cam_sin)) * sc_v_cam_size)) + 240.0), 480.0) - 240.0);
  sc_v_y = (mod(((sc_v_cam_y + (((sc_a_x * sc_v_cam_sin) + (sc_a_y * sc_v_cam_cos)) * sc_v_cam_size)) + 135.0), 270.0) - 135.0);
  sc_v_color_r = 0.0;
  sc_v_color_g = 255.0;
  sc_v_color_b = 0.0;
  if (((((sc_a_x * sc_a_x) + (sc_a_y * sc_a_y)) < sc_v_fade_in) && ((sc_a_x + (sc_a_y / 5.0)) > sc_v_fade_out))) {
    ...
    sc_v_atan = atan((((sc_v_y + 120.0) == 0.0) ? 1e20 : (sc_v_x / (sc_v_y + 120.0)))) * 57.29577951308232;
    if ((sc_v_dist < 32.0)) {
      sc_v_color_r = 255.0;
      sc_v_color_g = 255.0;
      sc_v_color_b = 255.0;
    ...
    if ((sc_v_dist < 102.0)) {
      if ((sc_v_dist > 85.0)) {
        if ((mod((sc_v_atan - (sc_v_beat * 30.0)), 60.0) < 20.0)) {
          sc_v_color_r = 255.0;
          sc_v_color_g = 255.0;
          sc_v_color_b = 255.0;
        }
    ...
    if ((sc_v_dist < 125.0)) {
      if ((sc_v_dist > 114.0)) {
        if ((mod((sc_v_atan + (sc_v_beat * 30.0)), 90.0) < 45.0)) {
          sc_v_color_g += 60.0;
          sc_v_color_b += 90.0;
        }
      }
    ...
    if ((sc_v_dist < 129.0)) {
      if ((sc_v_dist > 127.0)) {
        if ((mod((sc_v_atan + (sc_v_beat * 10.0)), 90.0) < 20.0)) {
    ...
    if ((sc_v_dist < 145.0)) {
      if ((sc_v_dist > 133.0)) {
        if ((mod((sc_v_x + (sc_v_y * 0.25)), 8.0) < 5.0)) {
          if ((mod((sc_v_atan - (sc_v_beat * 24.0)), 120.0) < 60.0)) {
            sc_v_color_g += 100.0;
            sc_v_color_b += 180.0;
          }
        }
    ...
    if ((sc_v_dist < 183.0)) {
      if ((sc_v_dist > 155.0)) {
        if ((sc_v_dist < 180.0)) {
          if ((mod((sc_v_atan - (sc_v_beat * -20.0)), 90.0) < 60.0)) {
            if ((mod((sc_v_x + (sc_v_y * -0.25)), 8.0) < 6.5)) {
          ...
          if ((mod(((sc_v_atan - (sc_v_beat * -20.0)) - 7.5), 90.0) < 45.0)) {
    ...
    if ((sc_v_dist < 194.0)) {
      if ((sc_v_dist > 188.0)) {
        if ((mod((sc_v_atan + (sc_v_beat * 35.0)), 45.0) < 30.0)) {
          sc_v_color_g += 60.0;
          sc_v_color_b += 90.0;
        }
      }
    ...
    if ((sc_v_dist < 225.0)) {
      if ((sc_v_dist > 200.0)) {
        if ((mod((sc_v_atan + (sc_v_beat * -15.0)), 45.0) < 30.0)) {
          if ((mod((sc_v_x + (sc_v_y * -0.25)), 10.0) < 1.5)) {
            sc_v_color_r += ((255.0 - sc_v_color_r) * 0.5);
            sc_v_color_g += ((255.0 - sc_v_color_g) * 0.5);
            sc_v_color_b += ((255.0 - sc_v_color_b) * 0.5);
          }
    ...
    if ((sc_v_dist < 235.0)) {
      if ((sc_v_dist > 230.0)) {
        if ((mod((sc_v_atan + (sc_v_beat * -40.0)), 45.0) < 30.0)) {
          sc_v_color_g += 50.0;
          sc_v_color_b += 90.0;
        }
      }
    ...
    sc_v_x2 = (mod((sc_v_x + 40.0), 80.0) - 40.0);
    sc_v_y2 = (mod((sc_v_y + 40.0), 80.0) - 40.0);
    ...
    if ((((sc_v_x > (-237.5 * sc_v_text_size)) && (sc_v_x < (237.5 * sc_v_text_size))) && ((sc_v_y > (-237.5 * sc_v_text_size)) && (sc_v_y < (237.5 * sc_v_text_size))))) {
      sc_v_i = ((floor(((((sc_v_text_size == 0.0) ? 1e20 : (((sc_v_x * cos((sc_v_text_dir) * 0.017453292519943295)) - (sc_v_y * sin((sc_v_text_dir) * 0.017453292519943295))) / sc_v_text_size)) + 237.5) * 2.0) + 0.5) + (floor(((70.5 - ((sc_v_text_size == 0.0) ? 1e20 : (((sc_v_x * sin((sc_v_text_dir) * 0.017453292519943295)) + (sc_v_y * cos((sc_v_text_dir) * 0.017453292519943295))) / sc_v_text_size))) * 2.0) + 0.5) * 949.0)) * 4.0);
...
void main() {
  ...
  sc_v_cam_x = sc_u_cam_x;
  sc_v_cam_cos = sc_u_cam_cos;
  sc_v_cam_sin = sc_u_cam_sin;
  sc_v_cam_size = sc_u_cam_size;
  sc_v_y = 85.03118717059795;
  sc_v_cam_y = sc_u_cam_y;
  sc_v_color_r = 103.43378215269578;
  sc_v_color_g = 121.66756430539158;
  sc_v_color_b = 136.19614448937426;
  sc_v_fade_in = sc_u_fade_in;
  sc_v_fade_out = sc_u_fade_out;
  ...
  sc_v_sw_radius1 = sc_u_sw_radius1;
  sc_v_sw_radius2 = sc_u_sw_radius2;
  sc_v_text_size = sc_u_text_size;
  sc_v_text_dir = sc_u_text_dir;
  sc_v_flash = sc_u_flash;
  sc_color = 0.0;
